...
%\part{Example Part}
\input{content/in}   % INCLUDE: introduction
\input{content/background}   % INCLUDE: introduction
\input{content/previous}   % INCLUDE: introduction
\input{content/methods}   % INCLUDE: introduction
\input{content/results}   % INCLUDE: introduction
\input{content/results2}   % INCLUDE: introduction
\input{content/conclusion}   % INCLUDE: introduction
...
\cleardoublepage
\input{content/apendix2}       % INCLUDE: appendix
